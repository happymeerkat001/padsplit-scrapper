...
- `padsplit_scraper/field_mms.py` — 6am/7pm CT Don-field group MMS (PadSplit host inbox + Discord #ai-tasks-temp). Sends via Quo SMS (`QUO_API_KEY`) first, then `google_voice_chrome.py` (Mac Chrome / Voice), then Messages `Don Field`.
